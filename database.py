...
#     "Test Id" SERIAL PRIMARY KEY,
#     "Chip Id" INTEGER,
#     FOREIGN KEY ("Chip Id") REFERENCES Chip2 ("Chip Id"),
#     "Test" VARCHAR,
#     "Date" VARCHAR,
#     "Temp" VARCHAR
# )
...
#                                             chip_id = cur.fetchone()
#                                             cur.execute("""
#                                                 INSERT INTO Test2 ("Test", "Date", "Temp", "Chip Id")
#                                                 VALUES (%s, %s, %s, %s)
#                                             """, (test, date, temp, chip_id))
#                                             conn.commit()
...
#     "File Id" SERIAL PRIMARY KEY,
#     "Test Id" INTEGER,
#     FOREIGN KEY ("Test Id") REFERENCES Test2 ("Test Id"),
#     "Test Data" VARCHAR,
#     "Instance Num" VARCHAR
# )
#      """) 
...
#                                                                 VALUES (%s, %s, %s)
#                                                                 """, (test_data, instance_num, test_id))
...
file_clone_path = os.path.join(folder_path, file_name)
# Retrieve bytea data
cur.execute('SELECT "Test Data" FROM test_file WHERE "File Id" = %s', (2892
