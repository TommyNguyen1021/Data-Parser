...
conn = psycopg2.connect(host="localhost", dbname="htdr",  user ="postgres", password = "numem@184", port = 5432)
                ...
                if test == 'vili' or test == 'macros':
                    ...
                    if os.path.exists(test_path) and os.path.isdir(test_path):
                        for lbw in os.listdir(test_path):
                            ...
                            # Seperates parts in lbw to be put into columns in the test table
