...
conn = psycopg2.connect(host="localhost", dbname="part_screening",  user ="postgres", password = "numem@184", port = 5432)
...
def main():
    ...
    WHERE 
        ...
        AND tf2."Test Data" LIKE '%%results%%'
    ...
    for checked_file in file_names_data:
        if("results" in checked_file and "dat_0" in checked_file):
