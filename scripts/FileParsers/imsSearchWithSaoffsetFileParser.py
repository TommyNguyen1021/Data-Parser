...
conn = psycopg2.connect(host="localhost", dbname="ims_search_with_saoffset",  user ="postgres", password = "numem@184", port = 5432)
...
def main():
    ...
    WHERE 
        t."Test" = 'ims_search_with_saoffset'
        AND c."Lot" = %s 
        AND c."Bin" = %s
        AND c."Wafer" = %s
