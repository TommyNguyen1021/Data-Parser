...
conn = psycopg2.connect(host="localhost", dbname="vili_main_v2_otp_bkdn",  user ="postgres", password = "numem@184", port = 5432)
    ...
    for data_files, file in zip(raw_data_files, file_names_data):
        ...
        with open(f"./parsed_files/{CHIP}/{TEST}/{part}/{part_num}/{temp + "_" + date}/{save_name}.txt", "wb") as save_file:
            ...
            if test_data:
                ...
                byte_data = bytes(test_data[0])  # Convert memoryview to bytes
